...
@Component({
    selector   : 'etraining-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : etrainingAnimations
})
export class EtrainingNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._etrainingNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._etrainingNavigationService.onItemCollapsed.next(this.item);
        this._etrainingNavigationService.onItemCollapseToggled.next();
    }
