...
@Component({
    selector       : 'etraining-navigation',
    templateUrl    : './navigation.component.html',
    styleUrls      : ['./navigation.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EtrainingNavigationComponent implements OnInit
{
    @Input()
    layout = 'vertical';
    ...
    ngOnInit(): void
    {
        ...
        this.navigation = this.navigation || this._etrainingNavigationService.getCurrentNavigation();
