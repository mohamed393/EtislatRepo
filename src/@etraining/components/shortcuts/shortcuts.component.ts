...
@Component({
    selector   : 'etraining-shortcuts',
    templateUrl: './shortcuts.component.html',
    styleUrls  : ['./shortcuts.component.scss']
})
export class EtrainingShortcutsComponent implements OnInit, AfterViewInit, OnDestroy
{
    shortcutItems: any[];
    navigationItems: any[];
    ...
    ngOnInit(): void
    {
        ...
        this.filteredNavigationItems = this.navigationItems = this._etrainingNavigationService.getFlatNavigation(this.navigation);
