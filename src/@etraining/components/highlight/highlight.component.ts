...
import '@etraining/components/highlight/prism-languages';

@Component({
    selector : 'etraining-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class EtrainingHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using etraining-highlight
        // component
