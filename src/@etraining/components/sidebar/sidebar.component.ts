...
import { EtrainingSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'etraining-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class EtrainingSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._etrainingConfigService.config
            ...
            .subscribe((config) => {
                this._etrainingConfig = config;
            });

        // Register the sidebar
        this._etrainingSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._etrainingSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('etraining-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('etraining-sidebar-overlay-invisible');
        }
