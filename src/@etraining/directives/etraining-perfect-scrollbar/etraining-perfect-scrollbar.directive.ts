...
import { EtrainingPerfectScrollbarGeometry, EtrainingPerfectScrollbarPosition } from '@etraining/directives/etraining-perfect-scrollbar/etraining-perfect-scrollbar.interfaces';
import { EtrainingConfigService } from '@etraining/services/config.service';

@Directive({
    selector: '[etrainingPerfectScrollbar]'
})
export class EtrainingPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set etrainingPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get etrainingPerfectScrollbarOptions(): any
    {
        // Return the options
     ...
     * @param {boolean | ""} value
     */
    @Input('etrainingPerfectScrollbar')
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.etrainingPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.etrainingPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): EtrainingPerfectScrollbarGeometry
    {
        return new EtrainingPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): EtrainingPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new EtrainingPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
